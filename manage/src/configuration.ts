  ...
  return {
    qingshandai: {
      ...
      Pagination: {
        ...
        itemColorActiveHover: !ifDark ? '#1e8f76' : '#116958',
    ...
    green: {
      ...
      Pagination: {
        ...
        itemColorActiveHover: !ifDark ? '#21cf64' : '#1a8750',
        itemTextColorActive: '#fff',
        itemTextColorHover: '#fff',
        itemTextColorPressed: '#fff',
      },
    ...
    blue: {
      ...
      Pagination: {
        itemColorActive: !ifDark ? '#1f71e0FF' : '#1c8aef',
        itemColorHover: !ifDark ? '#4792ed' : '#1f71e0FF',
        itemColorPressed: !ifDark ? '#1152ba' : '#6DB4F6FF',
        itemColorActiveHover: !ifDark ? '#4792ed' : '#1f71e0FF',
        itemTextColorActive: '#fff',
        itemTextColorHover: '#fff',
        itemTextColorPressed: '#fff',
      },
    ...
    luckin: {
      ...
      Pagination: {
        ...
        itemColorActiveHover: !ifDark ? '#33469e' : '#281d8f',
        itemTextColorActive: '#fff',
        itemTextColorHover: '#fff',
        itemTextColorPressed: '#fff',
      },
    ...
    purple: {
      ...
      Pagination: {
        ...
        itemColorActiveHover: !ifDark ? '#9254de' : '#722ed1',
        itemTextColorActive: '#fff',
        itemTextColorHover: '#fff',
        itemTextColorPressed: '#fff',
      },
    ...
    yellow: {
      ...
      Pagination: {
        ...
        itemColorActiveHover: !ifDark ? '#ffe252' : '#ffc300',
