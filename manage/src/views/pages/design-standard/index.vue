    ...
    <n-element>
      <div class="card">
        <div
          ...
          :style="{ color: !store.state.ifDark ? '#000000' : '#efefef' }"
        >
          设计规范 Design Standard
        </div>
        <div
          style="height: 1px; margin-left: -24px; margin-right: -24px"
          :style="{
            backgroundColor: !store.state.ifDark ? '#d1d5db4d' : '#ffffff17',
          }"
          class="my-2"
        ></div>
        ...
        <n-space align="center" justify="space-between">
          <n-space align="center">
            ...
            <div>
              ...
              <div
                :style="{ color: !store.state.ifDark ? '#1d2129' : '#b3b3b3' }"
              >
                核心组件库
              </div>
            </div>
          ...
          <n-button
            type="primary"
            size="large"
            @click="openWebsite('https://www.naiveui.com/')"
            >点击访问</n-button
          >
        </n-space>
        <div
        ...
        <n-space align="center" justify="space-between">
          ...
          <n-button
            type="primary"
            size="large"
            @click="openWebsite('https://www.xicons.org/')"
            >点击访问</n-button
          >
        </n-space>
        <div
        ...
        <n-space align="center" justify="space-between">
          ...
          <n-button
            type="primary"
            size="large"
            @click="openWebsite('https://ant.design/docs/spec/introduce-cn')"
            >点击访问</n-button
          >
        </n-space>
        <div
        ...
        <n-space align="center" justify="space-between">
          <n-space align="center">
            <div class="d-flex a-center j-center">
              ...
              >
                <g
                  ...
                  fill-rule="evenodd"
                >
                  <g id="画板" transform="translate(-26.000000, -14.000000)">
                    <g
                      id="编组-6备份"
                    ...
                    >
                      <g id="编组-3">
                        ...
                        <g
                          ...
                          :fill="!store.state.ifDark ? '#1d2129' : '#efefef'"
                        >
                          <path
            ...
            <div>
              <div
                :style="{ color: !store.state.ifDark ? '#000000' : '#b3b3b3' }"
              >
                字节跳动开源组件库
              </div>
            </div>
          ...
          <n-button
            type="primary"
            size="large"
            @click="openWebsite('https://arco.design/docs/spec/introduce')"
            >点击访问</n-button
          >
        </n-space>
      </div>
...
const bgColor = computed(() =>
  !store.state.ifDark ? 'rgba(255, 255, 255, 0.75)' : 'rgba(17, 25, 40, 0.75)'
)
